...
slug: foobal-a-new-hope
date: 2013-08-05
tags: ["foobal", "bug"]
description: In which I look forward to a new year of delighting and annoying my uncle.
aliases:
  - /post/2013/08/05/foobal-a-new-hope/
---
...
As you may remember, Foobal started out [pretty well](/posts/foobal-predicting-soccer-matches-with-scala-and-drools/). After half a season, it was still doing [quite OK](/posts/foobal-end-of-year-update/). And then... not so much. Unfortunately. Foobal and I finished fourth; a position shared with three other people. In other words: slightly above the middle.
