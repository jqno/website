...
slug: generics-in-equalsverifier-part-1
date: 2016-06-23
tags: ["equalsverifier", "generics"]
description: In which I take a deep dive into Java's reflection API.
aliases:
  - /post/2016/06/23/generics-in-equalsverifier-part-1/
---
This is part 1 of a two-part series. This part deals with overcoming type erasure. In [Part 2](/posts/generics-in-equalsverifier-part-2/), we will see what EqualsVerifier can do with this generic type information.
...
Summary
---
We have seen how we can determine the full, generic type of a class's field. In [Part 2](/posts/generics-in-equalsverifier-part-2/), we will see how we can put this information to good use.
