...
slug: reading-blogs-on-my-kobo-ereader-via-wallabag
date: 2025-06-04
tags: ["kobo", "wallabag"]
description: In which I compare two options for reading blog posts on my e-reader, using the Wallabag read-it-later service.
aliases:
  - /post/2025/06/04/reading-blogs-on-my-kobo-ereader-via-wallabag/
---
...
![Kobo's "Computer detected" screen](computer-detected.webp)
...
![KOReader's articles list on my Kobo](koreader.webp)
...
![An article on my Kobo set in TilburgsAns](tilburgsans.webp)

I've [talked about fonts on this blog](/posts/about-fonts/) before, and I thought it might be nice to share how I installed my preferred fonts on my Kobo device. It doesn't have anything to do with Wallabag, but it makes reading on my Kobo so much nicer 😄. And if you've successfully installed Wallabag (through either method) on your e-reader, this is now simple.
