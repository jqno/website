...
slug: generics-in-equalsverifier-part-2
date: 2016-06-26
tags: ["equalsverifier", "generics"]
description: In which I apply the things I've learned in the previous post.
aliases:
  - /post/2016/06/26/generics-in-equalsverifier-part-2/
---
In [Part 1](/posts/generics-in-equalsverifier-part-1/) of this two-part series, we have explored how to determine the full, generic type of a class's fields. Now it's time to do something with this information: instantiate an object of any given type.
...
Most of the time that would work. It would only fail when the list is 'unpacked', like in the `SparseArray` example in [Part 1](/posts/generics-in-equalsverifier-part-1/).
...
Summary
---
In [Part 1](/posts/generics-in-equalsverifier-part-1/), we have explored how we can determine the full generic type of a field in a class. In this part, we have seen how we can leverage this information to build instances of objects that respect these generics.
