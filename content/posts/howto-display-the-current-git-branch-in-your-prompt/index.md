...
slug: howto-display-the-current-git-branch-in-your-prompt
date: 2012-04-02
tags: ["bash", "git", "how-to", "prompt"]
description: In which I show my fancy color prompt script.
aliases:
  - /post/2012/04/02/howto-display-the-current-git-branch-in-your-prompt/
---
...
Or better yet: add it to [your Dropbox](/posts/configuration-sharing-with-dropbox-part-3-bash/)!
