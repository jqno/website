...
slug: annotationscript-abusing-java-annotations-to-the-extreme
date: 2021-01-01
tags: ["java", "lisp", "annotation", "annotationscript"]
description: In which I take things way too far by implementing LISP using only Java annotations, then using that language to implement another LISP.
aliases:
  - /post/2021/01/01/annotationscript-abusing-java-annotations-to-the-extreme/
---
## TL;DR
