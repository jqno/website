...
description: In which I discuss how I use Vim instead of an IDE to edit Java code.
aliases:
  - /post/2020/09/09/my-vim-setup/
---
## Background
...
![Java with completions in Vim](vim-2.png)
...
![Scala with NERDTree in Vim](vim-3.png)
