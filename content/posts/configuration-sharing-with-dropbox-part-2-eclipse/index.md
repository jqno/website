...
slug: configuration-sharing-with-dropbox-part-2-eclipse
date: 2012-03-17
tags: ["configuration", "dropbox", "eclipse", "how-to"]
description: Part 2 of my series, in which I show how I shared my Eclipse configuration through Dropbox, using the Workbench Mechanic plugin.
aliases:
  - /post/2012/03/17/configuration-sharing-with-dropbox-part-2-eclipse/
---
...
[Part 0](/posts/configuration-sharing-with-dropbox-part-0-introduction/)
anyway.
...
* Under Task Sources, click the New button.<br>
  ![Eclipse window preferences](eclipse-window-preferences.png)
