...
slug: on-transitivity
date: 2013-03-26
tags: ["equals", "equalsverifier", "java"]
description: In which I follow up on a problem I discovered in my previous post.
aliases:
  - /post/2013/03/26/on-transitivity/
---
[Last time](/posts/reaction-to-cedric-beusts-equals-challenge/), I discussed a transitivity issue for `equals` methods that also affects [EqualsVerifier](http://www.jqno.nl/equalsverifier). To recap, consider this class:
