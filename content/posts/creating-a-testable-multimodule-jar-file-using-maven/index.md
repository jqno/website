...
slug: creating-a-testable-multimodule-jar-file-using-maven
date: 2022-10-19
tags: ["equalsverifier", "java", "maven", "multi-release-jar-file"]
description: "In which I describe how I implemented EqualsVerifier's multi-release jar file build using Maven, and discuss the issues I had to solve to get there."
aliases:
  - /post/2022/10/19/creating-a-testable-multimodule-jar-file-using-maven/
---
